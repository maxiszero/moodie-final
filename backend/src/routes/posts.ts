...
const { getPosts, getMoodStats, searchPosts, createPost, toggleLike, toggleReaction, toggleRelatable, reportPost, deletePost, getAiTip } = require('../controllers/postController');

...
def fallback_analysis(text: str) -> dict[str, Any]:
    ...
    checks: list[tuple[str, dict[str, Any]]] = [
        (r"апати|всё равно|ничего не чувств|numb|apat", {"emotion": "apathy", "emoji": "😶", "intensity": 40, "color": "#CBD5E1", "color2": "#94A3B8", "color3": "#64748B", "reasoning": "Чувство безразличия.", "tip": "Иногда ничего не чувствовать - это тоже нормально 😶"}),
        ...
        (r"устал|tired|sleep|спать", {"emotion": "tired", "emoji": "😫", "intensity": 60, "color": "#E7E5E4", "color2": "#D6D3D1", "color3": "#A8A29E", "reasoning": "Нужен отдых.", "tip": "Пора отдохнуть и набраться сил 🔋"}),
        ...
        for api_key in keys:
            try:
                ...
                return {
                    ...
                    "color": color1 or "#9E9E9E",
                    "color2": parsed.get("color2") or color1 or "#757575",
                    "color3": parsed.get("color3") or parsed.get("color2") or color1 or "#616161",
